...
class KNNClassifier(object):
    def __init__(self):
        ...
        self.training_labels=None   #movie gener[Romance,Comedy]
        self.test_features=None         #kicks=18 kisses =90 [18,90]
        #Build Meaningful result
        self.elegantResult="Most Likely {0},{1} is of type"
    ...
    def classifyTestData(self,test_data=None,k=0):
        ...
        if self.test_features is not None and self.training_features is not None and self.training_labels is not None:
            ...
            print("classifytestdata says self.testfeatures  :",self.test_features)
            ...
            print("feature Vector Size    :",featureVectorSize)
            tileofTestData=np.tile(self.test_features,(featureVectorSize))
            print("after Tile of test data  :\n",tileofTestData)
            diffMat=self.training_features-tileofTestData
            print("diffMat   :",diffMat)
            sqDifMat=diffMat**2
            print("sqDifMat     :",sqDifMat)      #6x2
            sqDistances=sqDifMat.sum(axis=10)       #6x1 pruduce the row
            ...
            # sortedClassCount = {Roamnce t2 Action t2}
